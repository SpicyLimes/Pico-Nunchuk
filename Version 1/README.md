## Pico-Nunchuk — Version 1 (CAD Only)

> **This is the original, single-profile release.**
> For the current version with profile switching, see [Version 2](../Version%202/README.md).

Use a Wii Nunchuk as a USB HID input device for TinkerCAD (and other CAD software) via a Raspberry Pi Pico 2 W.

The Nunchuk's joystick and buttons are mapped to mouse and keyboard actions for 3D viewport navigation — zoom, pan, orbit, and object manipulation — without touching a traditional mouse.
